...
datas = wto.WtoDatabase3(path='/users/aod/.cycle3pt/', loadp1=False)
allsbC3 = pd.merge(
    pd.merge(
...
allsbC3.sort('CODE').to_csv('/data/Cycle3/daily-backup/allC3.sbinfo', sep='\t', index=False, header=False)
datas._cursor.close()
