...
refr = False
if time.time() - os.path.getmtime('/users/aod/.mwto_c362/') > 3600.:
    refr = True
try:
    datas = Data.DsaDatabase3(refresh_apdm=refr, path='/users/aod/.mwto_c362/',
                              allc2=False, loadp1=False)
except IOError:
    datas = Data.DsaDatabase3(path='/users/aod/.mwto_c362/',
                              allc2=False, loadp1=False)
